...
class TestGPUChannelOrthVsNonOrth1000Cells(unittest.TestCase):
    def test_gpu_sweep_1000_cells(self):
        out = run_gpu_nonorth_vs_orth_sweep(
            ...
            artifact_tag="swe2d_nonorth_vs_orth_gpu_sweep_1000cells",
        )
        ...
        self.assertLess(out["max_rel_q_pct"], 6.0, f"rel_q delta too high: {out['max_rel_q_pct']:.4f}%")
