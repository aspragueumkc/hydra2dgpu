"""Core runtime source-term application helpers.

Pure-Python forwarding functions that apply boundary-source and external-source
terms.  These helpers live in ``swe2d.core`` so the executor and other core
modules can consume them without importing from a GUI layer.
"""
