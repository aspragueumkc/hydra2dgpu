...
def wire_run_dock_signals(dialog) -> None:
    ...
    safe_disconnect(d.batch_btn.clicked, dialog._run_controller.open_batch_simulation_dialog)
    d.batch_btn.clicked.connect(dialog._run_controller.open_batch_simulation_dialog)
