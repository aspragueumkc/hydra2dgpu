"""Dock management and launch functions for SWE2D Studio."""
...
def _install_studio_host_controls(
    ...
    """Install workbench-scoped controls into the QGIS host window."""
...
def launch_swe2d_workbench_studio(parent=None, iface=None):
    """Launch the SWE2D workbench Studio dialog (docked mode).
    ...
    dlg._swe2d_workbench_host_mode = "dock"
    try:
    ...
    _install_studio_host_controls(iface, dlg, host_window)
    try:
