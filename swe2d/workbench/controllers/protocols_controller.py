...
class RunView(Protocol):
    ...
    def get_input_item(self, title: str, label: str, items: List[str], current: int = 0, editable: bool = False) -> Tuple[str, bool]:
        """Show an item-selection dialog; return (selected_text, ok)."""
