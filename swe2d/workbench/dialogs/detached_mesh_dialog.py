...
class SWE2DDetachedMeshViewDialog(QtWidgets.QDialog):
    def __init__(
        ...
        self.view_mode_combo.setToolTip("Select mesh view mode: Mesh wireframe, Depth, or Velocity magnitude.")
        ...
        self.refresh_btn.setToolTip("Re-render the mesh view with current data.")
