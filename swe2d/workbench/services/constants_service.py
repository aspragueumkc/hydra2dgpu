...
# Remove once all call-sites are updated to the public names above.

_BC_INFLOW_Q = BC_INFLOW_Q
_BC_TS_FLOW = BC_TS_FLOW
_BC_TS_STAGE = BC_TS_STAGE
_BC_VALUE_MAP = BC_VALUE_MAP
_BC_OPTIONS = BC_OPTIONS
_CELL_TYPE_OPTIONS = CELL_TYPE_OPTIONS
_RECONSTRUCTION_OPTIONS = RECONSTRUCTION_OPTIONS
_TEMPORAL_ORDER_OPTIONS = TEMPORAL_ORDER_OPTIONS
_STRUCTURE_TYPE_VALUE_MAP = STRUCTURE_TYPE_VALUE_MAP
_DRAIN_NODE_TYPE_VALUE_MAP = DRAIN_NODE_TYPE_VALUE_MAP
_DRAIN_LINK_TYPE_VALUE_MAP = DRAIN_LINK_TYPE_VALUE_MAP
_DRAIN_LINK_SHAPE_VALUE_MAP = DRAIN_LINK_SHAPE_VALUE_MAP
_RAIN_GAGE_UNITS_VALUE_MAP = RAIN_GAGE_UNITS_VALUE_MAP
_HYETOGRAPH_VALUE_TYPE_MAP = HYETOGRAPH_VALUE_TYPE_MAP
_HYETOGRAPH_UNITS_VALUE_MAP = HYETOGRAPH_UNITS_VALUE_MAP
