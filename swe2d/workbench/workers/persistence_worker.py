    ...
    def run(self):
        try:
            ...
            status = finalizer.finalize_and_persist(
                ...
                save_line_results=bool(getattr(self._result, 'save_line_results', False)),
                save_coupling_results=bool(getattr(self._result, 'save_coupling_results', False)),
                save_mesh_results=bool(getattr(self._result, 'save_mesh_results', False)),
                save_run_log=bool(getattr(self._result, 'save_run_log', False)),
                save_max_only=bool(getattr(self._result, 'save_max_only', False)),
                h_min=float(getattr(self._result, 'h_min', 1.0e-4)),
