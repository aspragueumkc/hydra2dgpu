...
<qgis version="3.34.4" styleCategories="Fields|Forms|AttributeTable">
  ...
  <aliases>
    <alias index="0" field="constraint_id" name="Constraint ID"/>
  ...
  <defaults>
    <default expression="" field="constraint_id" applyOnUpdate="0"/>
  ...
  <constraints>
    <constraint notnull_strength="0" exp_strength="0" constraints="0" field="constraint_id" unique_strength="0"/>
  ...
  <constraintExpressions>
    <constraint exp="" field="constraint_id" desc=""/>
