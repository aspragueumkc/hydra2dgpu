...
// GPU/CUDA only — CPU/OpenMP path has been removed.
...
// ─────────────────────────────────────────────────────────────────────────────
/// GPU availability — CPU-only stub (overridden by swe2d_gpu.cu when compiled)
...
// ─────────────────────────────────────────────────────────────────────────────
/** One explicit Euler timestep on CPU (compatibility fallback only).
    All active numerical work targets the CUDA path in swe2d_gpu.cu.
    Do not backport GPU-only improvements here unless required for
    CPU fallback to remain runnable. @param s Solver handle @param dt Timestep
